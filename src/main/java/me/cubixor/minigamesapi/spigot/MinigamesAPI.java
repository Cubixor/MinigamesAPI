...
public class MinigamesAPI {
    ...
    public static void registerPAPI(ArenasRegistry arenasRegistry, StatsManager statsManager) {
        registerPAPI(arenasRegistry, statsManager, null);
    }

    public static void registerPAPI(ArenasRegistry arenasRegistry, StatsManager statsManager, PlaceholderParser placeholderParser) {
        if (Bukkit.getPluginManager().getPlugin("PlaceholderAPI") != null) {
            PlaceholderExpansion placeholderExpansion = new PlaceholderExpansion(arenasRegistry, statsManager, placeholderParser);
